...
import { AccessTokenData } from '../authorize/types/authorize.types';
...
export class UserResolver {
     ...
     *
     * @param {AccessTokenData} jwtTokenData - The JWT token data containing user identification information.
     * @returns {Promise<User | null>} - The user object if found, otherwise null.
     */
    @UseGuards(GqlThrottlerGuard)
    @SkipThrottle({ short: true })
    @Query(() => User, { name: 'me' })
    public async me(@CurrentUser() jwtTokenData: AccessTokenData): Promise<User | null> {
